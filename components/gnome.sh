...
# Change fonts
dconf write /org/gnome/desktop/interface/font-name "'Cantarell Regular 11'"
dconf write /org/gnome/desktop/interface/document-font-name "'Sans Regular 11'"
dconf write /org/gnome/desktop/interface/monospace-font-name "'IntelOne Mono 11'"
...
# Change touchpad and mouse configurations
...
# Change locking key
dconf write /org/gnome/settings-daemon/plugins/media-keys/screensaver "'<Ctrl><Alt>q'"
